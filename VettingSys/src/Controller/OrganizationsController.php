...
class OrganizationsController extends AppController
{
    ...
    public function AdvancedSearch(){
        ...
        if($status1 && $country==0){
            $organizations = $this->paginate($this->Organizations->findAllByStatus($status1));
        }else{
            if($status1 && $country!=0){
                $organizations = $this->paginate($this->Organizations->findAllByStatusAndIdCountry($status1,$country));
            }else{
