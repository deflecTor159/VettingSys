    ...
    <div id="content">
        <div class="row">
            ...
            <div class="columns large-12 checks">
                <h4 align="center"> New Vetting Process</h4>

                <?php
                echo $this->Form->create($page, ['type' => 'get','url' =>['controller'=> 'vetting' ,'action'=> 'index']]);
                echo $this->Form->input('Name', array('placeholder' => 'Name'));
                echo $this->Form->input('Email',array('placeholder' => 'Email','type' => 'email'));
                echo $this->Form->input('Comments', array('placeholder' => 'Comments'));
